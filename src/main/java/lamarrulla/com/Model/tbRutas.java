...
public class tbRutas {
	...
	public void tbRutasInsert(
			...
			double fdoStartLocationLat,
			double fdoStartLocationLng) {		
		qryStringInsert = String.format("insert into tbRutas (fcDistance, fiDistance, fcDuration, fiDuration, fcEndAddress, fdoEndLocationLat, fdoEndLocationLng, fcStartAddress, fdoStartLocationLat, fdoStartLocationLng)values('%s', %o, '%s', %o, '%s', %f, %f, '%s', %f, %f);",
				fcDistance,
				fiDistance,
				fcDuration,
				fiDuration,
